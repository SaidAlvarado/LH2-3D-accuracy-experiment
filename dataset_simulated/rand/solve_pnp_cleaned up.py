...
lh1_ax.scatter(proj_pts_A[:,0], proj_pts_A[:,1], edgecolor='red', facecolor='red', alpha=0.3, lw=1, label="LH1 - GT")
lh2_ax.scatter(proj_pts_B[:,0], proj_pts_B[:,1], edgecolor='red', facecolor='red', alpha=0.3, lw=1, label="LH2 - GT")
